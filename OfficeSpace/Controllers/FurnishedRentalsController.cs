...
namespace OfficeSpace.Controllers
{
    ...
    public class FurnishedRentalsController : BaseController
    {
        private readonly IRequestBusinessService _RequestBussinessService;
        // GET: FurnishedRentals
        public FurnishedRentalsController(IRequestBusinessService RequestBussinessService, ILogService logService) : base(logService)
        {
